...
try {
    ...
    $tradeLogData = $db->findOne('tr_trade_log', ['no'=>$_POST['tradeNo']], 'i', 'FOR UPDATE');
    ...
    $sellerData = $db->findOne('tr_mileage', ['user_no'=>$tradeLogData['seller_no']], 'i', 'FOR UPDATE');
    ...
    $sellerMileageLogNo = $db->save('tr_mileage_log', ['user_no'=>$sellerData['user_no'], 'method'=>'trade', 'method_no'=>$_POST['tradeNo'], 'before_mileage'=>$sellerData['use_mileage'],
                                            'use_mileage'=>$realPrice, 'after_mileage'=>$sellerData['use_mileage'] + $realPrice], 'isiiii');
